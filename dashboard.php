...
<?php
    session_start();
    /* we will want to convert these to database tables eventually */
   
  
    
    /* we want a db table called studentClassTutor w/ id's of student, class, and tutor
     for each student / tutor relationship */
...
>>>>>>> d3e52281e18ff9b721297e8f0948f54dcc1e1f66
<!DOCTYPE html>
...
<?php
    ...
    if(isset($_COOKIE['email']) or isset($_COOKIE['name_user'])){
